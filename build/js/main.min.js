...
/* harmony import */ var _modules_init_mobile_menu__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/init-mobile-menu */ "./js/modules/init-mobile-menu.js");
/* harmony import */ var _modules_send_form__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/send-form */ "./js/modules/send-form.js");
/* harmony import */ var _modules_gsap_animation__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/gsap-animation */ "./js/modules/gsap-animation.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  // ---------------------------------
  Object(_modules_init_mobile_menu__WEBPACK_IMPORTED_MODULE_5__["manageMobileMenu"])();
  Object(_modules_init_slider__WEBPACK_IMPORTED_MODULE_4__["initSlider"])();
  Object(_modules_send_form__WEBPACK_IMPORTED_MODULE_6__["sendForm"])();
...
// Intro animation
var tlMain = gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].timeline();
var main = document.querySelector('main');
gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].from('.main-nav__item', {
  opacity: 0,
  y: -100,
  duration: 1,
  stagger: 0.2
});
gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].from('.socials__item', {
  opacity: 0,
  y: 100,
  duration: 1,
  stagger: 0.2
}, 1);
var titleAnim = function titleAnim() {
  var title = document.querySelector('.intro__title');
  var subtitle = document.querySelector('.intro__text');
  ...
  var split = splitText(title);
  function random(min, max) {
    return Math.random() * (max - min) + min;
  }
  Array.from(split.querySelectorAll('.letter')).forEach(function (el, idx) {
...
gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].to('.intro .container', {
  scrollTrigger: {
    trigger: '.intro',
    markers: true,
    start: 'top top',
...
gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].to('.bg-block__img', {
  scrollTrigger: {
    trigger: '.intro',
    start: 'top top',
    scrub: true
...
/*!****************************************!*\
  !*** ./js/modules/init-mobile-menu.js ***!
  \****************************************/
/*! exports provided: manageMobileMenu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "manageMobileMenu", function() { return manageMobileMenu; });
...
var mobMenu = document.querySelector('[data-header]');
var menuBtn = document.querySelector('[data-burger]');
...
var manageMobileMenu = function manageMobileMenu() {
  if (menuBtn) {
...
var initSlider = function initSlider() {
  var swiper = new Swiper('[data-reviews-slider]', {
    speed: 2000,
    loop: true,
    slidesPerView: 1,
    watchOverflow: true,
...
function showStatusModal(message) {
  var prevModal = document.querySelector('[data-modal="reserve"]');
  var statusModal = document.querySelector('[data-modal="feedback"]');
  var closeModalBtns = statusModal.querySelectorAll('[data-close-modal]');
  var content = statusModal.querySelector('.modal-feedback');
  prevModal.classList.remove('is-active');
  statusModal.classList.add('is-active');
  content.innerHTML = "\n    <p class=\"modal__title\">".concat(message, "</p>\n  ");
